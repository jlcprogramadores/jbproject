<div class="box box-info padding-1">
    <div class="box-body"> 
        ...
        <div class="p-1 form-group">
            ...
            {{ Form::date('fecha_inicio', $paro->fecha_inicio, ['class' => 'form-control-sm',  'required' => 'required' . ($errors->has('fecha_inicio') ? ' is-invalid' : ''), 'placeholder' => 'Fecha De Pago']) }}
            {!! $errors->first('fecha_inicio', '<div class="invalid-feedback">Campo requerido *</div>') !!}
        </div>
        <div class="p-1 form-group">
            {{ Form::label('fecha_fin') }}
            {{ Form::date('fecha_fin', $paro->fecha_fin, ['class' => 'form-control-sm',  'required' => 'required' . ($errors->has('fecha_fin') ? ' is-invalid' : ''), 'placeholder' => 'Fecha De Pago']) }}
    ...
    <div class="box-footer mt20">
        ...
        <button type="submit" class="btn btn-primary" onclick="habilitarGrupo()"" style="display:none;" id="btnAceptar">Aceptar</button>
    </div>
</div>
