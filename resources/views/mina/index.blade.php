                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('minas.destroy',$mina->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('minas.show',$mina->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('minas.edit',$mina->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
