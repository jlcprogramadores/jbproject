...
<div class="box box-info padding-1">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm p-1 form-group">
                {{ Form::label('familia') }}
                {{ Form::select('Selecciona Familia',$datosfamilia, $finanza->categoria_id, ['class' => 'form-control' . ($errors->has('categorias_de_entrada_id') ? ' is-invalid' : ''), 'placeholder' => 'Selecciona Familia']) }}
