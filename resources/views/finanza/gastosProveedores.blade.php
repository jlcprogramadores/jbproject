                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('finanzas.tablaGastosProveedores') }}" role="form"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm p-1 form-group ">
                                                <label class="proyecto_id" name="Ingreso_id" for="Ingreso_id">Gastos de Proveedores por Proyecto:</label>
                                                <br>
                                        ...
                                        <div class="row justify-content-md-center">
                                            <button id="btn_graficar" type="submit"
                                                class="btn btn-primary col col-lg-3">Obtener Gastos</button>
                                        </div>
                                    </div>
                                    <br>
                                </form>
