                                        ...
                                        <tbody>
                                            @foreach ($finanzas as $finanza)
                                                <tr>
                                                    ...
                                                    <td>{{ $finanza->no }}</td>
                                                    <td>{{ Carbon\Carbon::parse($finanza->fecha_entrada)->format('Y-m-d') }}
                                                    </td>
                                                    <td>{{ Carbon\Carbon::parse($finanza->fecha_salida)->format('Y-m-d') }}</td>
                                                    <td>{{ $finanza->vence }}</td>
                                                    <td>{{ $dias = Carbon\Carbon::parse(strtotime($finanza->fecha_salida . '+ ' . $finanza->vence . ' days'))->format('Y-m-d') }}
                                                    </td>
                                                    <?php
                                                    ...
                                                    @if ($diferencia_en_dias <= 0)
                                                        <td>
                                                            <p class="badge bg-danger">Vencido</p>
                                                        </td>
                                                    @else
                                                        <td>
                                                            <p class="badge bg-warning text-dark">Por vencer</p>
                                                        </td>
                                                    @endif
                                                    ...
                                                    ?>
                                                    <td> <span style=" white-space: nowrap">{{ $fam }}</span> <br />
                                                        <span style=" white-space: nowrap">{{ $cat }}</span> </td>
                                                    <td>{{ $finanza->salidas_id ? $finanza->salida->proveedore->razon_social : $finanza->entrada->cliente->razon_social }}
                                                    </td>
                                                    ...
                                                    <td>{{ '$' . number_format($montoAPagar = $finanza->monto_a_paga,2) }}</td>
                                                    ...
                                                    @else
                                                        <td>
                                                            <p class="badge bg-danger">Pendiente Pagar</p>
                                                        </td>
                                                    @endif
