							...
							<table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
								<tr>
									<td style="padding:0 0 36px 0;color:#153643;">
										...
										<p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;" >Estimado Proveedor {{$nombreProveedor}}, el presente correo hace llegar su comprobante de pago por la cantidad de ${{number_format($monto_a_pagar,2)}} M.X.N. </p>
